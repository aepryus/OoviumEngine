...
public class Migrate {
    ...
    fileprivate static func migrateChainTo301(_ tokensString: String, subs: [Subs]) -> String {
	...
	public static func migrateAether(json: String) -> String {
        ...
        if migrate {
            ...
            attributes = attributes.modify(query: chainNames, convert: { (value: Any) in
                Migrate.migrateChainTo301(value as! String, subs: subs)
            })
        }
